...
//            sourceTree = MobileAndEditorUXTree;
            ...
            Text feedbackText = sourceTree.GetComponentInChildren<Text>();
            if (feedbackText != null)
            {
                Debug.Log("feedbackText.name=" + feedbackText.name);
                return feedbackText;
            }
/*
            Debug.Log("GetFeedbackText childCount=" + sourceTree.transform.childCount);
...
*/
        ...
        public GameObject GetFeedbackPanel()
        {
            ...
            var children = sourceTree.GetComponentsInChildren<Transform>();
